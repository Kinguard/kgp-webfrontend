( function( angular ) {
    ...
    var directiveId = 'ngRemoteValidate',
        remoteValidate = function( $http, $timeout, $q, opi ) {
            return {
                restrict: 'A',
                require: 'ngModel',
                link: function( scope, el, attrs, ngModel ) {
                    ...
                    if( options.ngRemoteValidate.charAt( 0 ) === '[' ) {
                        ...
                        options.urls = [ opi.apiUrl+options.ngRemoteValidate ];
                    }
...
*/
    opiaDirectives.directive(directiveId, [ '$http', '$timeout', '$q', 'OPI', remoteValidate ] );
